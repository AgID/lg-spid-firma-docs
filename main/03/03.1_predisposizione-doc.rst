...
Il processo prevede che l'SP conosca il codice fiscale del firmatario; il SP quindi:

.. topic:: Procedura
   :class: procedure

   1. Presente all’utente il bottone  “**Firma con SPID**”, alla cui selezione il SP
   ...
   3. Il SP rendendo manifesto all’utente che il processo prevede l’invio del documento
